...
The arguments are: label, message, labelColor, backgroundColor, logoSpacing, logo, style
In JSOn FORMAt:  {"label":"","message":"","labelColor":"","backgroundColor":"", logoSpacing":null,"logo":"","style":""}
    """
